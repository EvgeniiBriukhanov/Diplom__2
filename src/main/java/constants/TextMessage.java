...
public class TextMessage {
    ...
    public final static String USER_LOGIN_INCORRECT_DATA_401 = "email or password are incorrect";
    public final static boolean USER_LOGIN_FAILED_401 = false;
    public final static boolean LOGIN_SUCCESSFUL_200 = true;
